    ...
    <section className="banner-area">
        <div className="container mx-auto px-4 py-4 grid grid-cols-3 gap-4 lg:relative lg:pt-[250px] lg:pb-[250px]">
            ...
            <div className="infos-user col-span-4 lg:col-start-1 lg:col-span-1 z-2">
                ...
                <a href="/peterroberto-dev-front-end.pdf" className='mt-5 w-[200px] text-[18px] py-3 button rounded-full text-white bg-blue-800 font-bold hover:bg-blue-900 transition-colors duration-300 ease-in-out rounded-3xl flex items-center justify-center' target='_blank'> 
                    Baixar currículo
